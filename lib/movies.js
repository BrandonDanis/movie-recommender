...
module.exports = {
    ...
    getPopularMultiGenre: {
					...
					if (rows[0] != null) {
						module.exports.getRatings(rows, function (result) {
							if (result['status'] == 200 && rows.length != 10) {
								module.exports.getPopularMultiGenre.getMoreMovies(query, rows, genres,
									function (result) {
										callback(result);
									});
							} else {
						...
						module.exports.getPopularMultiGenre.getMoreMovies(query, [], genres, function (result) {
							callback(result);
						});
					}
				} else {
		...
		getMoreMovies: function (query, movies, genres, callback) {
